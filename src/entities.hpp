...
EntityHandle create_point_light(Entities *entities, Resources *resources, Shader *shader, const Mat4f &transform,
								const LightEmmiter &light_emmiter, u32 diffuse_texture, u32 specular_texture);

EntityHandle create_plane(Entities *entities, Resources *resources, Shader *shader,
