...
lt_internal const Vec3f UNIT_CUBE_VERTICES[24] =
{
    ...
    Vec3f(-1.0f, -1.0f,  1.0f), // 8
    Vec3f(-1.0f,  1.0f,  1.0f), // 9
    Vec3f(-1.0f,  1.0f, -1.0f), // 10
    Vec3f(-1.0f, -1.0f, -1.0f), // 11
    Vec3f( 1.0f, -1.0f,  1.0f), // 12
    Vec3f( 1.0f, -1.0f, -1.0f), // 13
    Vec3f( 1.0f,  1.0f, -1.0f), // 14
    Vec3f( 1.0f,  1.0f,  1.0f), // 15
    Vec3f(-1.0f,  1.0f,  1.0f), // 16
    Vec3f( 1.0f,  1.0f,  1.0f), // 17
    Vec3f( 1.0f,  1.0f, -1.0f), // 18
    Vec3f(-1.0f,  1.0f, -1.0f), // 19
    Vec3f(-1.0f, -1.0f,  1.0f), // 20
    Vec3f(-1.0f, -1.0f, -1.0f), // 21
    Vec3f( 1.0f, -1.0f, -1.0f), // 22
    Vec3f( 1.0f, -1.0f,  1.0f), // 23
};
